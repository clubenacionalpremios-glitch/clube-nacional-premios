      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family:Arial;padding:20px;line-height:1.6">
            ...
            <p>
              Seu cadastro foi realizado com sucesso no
              <strong>Clube Nacional de Prêmios</strong>.
            </p>
            ...
            <p style="margin-top:25px">
              Guarde este número. Ele será utilizado nos sorteios.
            </p>
